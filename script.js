function clearAll(){// to clear all the thing 
...
function showMeme(){
    const randomMemUrl=getRandomData('memes');
    const container=document.querySelector('.meme-content');
    const newImage=document.createElement('img');
    newImage.setAttribute('src',randomMemUrl);
    clearAll();// remove all the prevoius images
...
function showQuote(){
    const randomQuotes=getRandomData('quotes');
    const quotesContainer=document.querySelector('.quote-content');
    const newQuoteText=document.createElement('p');
    const newQuoteAuthor=document.createElement('p');
    newQuoteText.textContent=randomQuotes.quote;
    newQuoteAuthor.textContent="- "+randomQuotes.author;
    clearAll();
    quotesContainer.appendChild(newQuoteText);
...
function showRiddle(){
    ...
    const newRiddleAns=document.createElement('p');
    newRiddleQuestion.textContent=randomRiddle.question;
    newRiddleAns.textContent="- "+randomRiddle.answer;

    newRiddleAns.setAttribute("id", "riddle-answer");// set an id to take care of the ans case
    clearAll();
    // how to deal with ans

    newRiddleAns.hidden=true;
    riddleContainer.appendChild(newRiddleQuestion);
    riddleContainer.appendChild(newRiddleAns);
...
function showAns(){
    ...
    else if(Check && ans) alert('Riddle and is already exposed');
    else alert('No such riddle ans exists');
}
